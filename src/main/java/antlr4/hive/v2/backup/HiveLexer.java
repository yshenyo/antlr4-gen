...
public class HiveLexer extends Lexer {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'TIME'", "'ZONE'", "'INTERVAL'", "'DECIMAL'", "'STRING'", "'CHAR'", 
			"'VARCHAR'", "'ARRAY'", "'STRUCT'", "'MAP'", "'UNIONTYPE'", "'REDUCE'", 
			"'PARTITIONED'", "'CLUSTERED'", "'SORTED'", "'INTO'", "'BUCKETS'", "'ROW'", 
			"'ROWS'", "'FORMAT'", "'DELIMITED'", "'FIELDS'", "'TERMINATED'", "'ESCAPED'", 
			"'COLLECTION'", "'ITEMS'", "'KEYS'", "'$KEY$'", "'KILL'", "'LINES'", 
			"'STORED'", "'FILEFORMAT'", "'INPUTFORMAT'", "'OUTPUTFORMAT'", "'INPUTDRIVER'", 
			"'OUTPUTDRIVER'", "'ENABLE'", "'DISABLE'", "'LOCATION'", "'TABLESAMPLE'", 
			"'BUCKET'", "'OUT'", "'OF'", "'PERCENT'", "'CAST'", "'ADD'", "'REPLACE'", 
			"'RLIKE'", "'REGEXP'", "'TEMPORARY'", "'FUNCTION'", "'MACRO'", "'FILE'", 
			"'JAR'", "'EXPLAIN'", "'EXTENDED'", "'FORMATTED'", "'DEPENDENCY'", "'LOGICAL'", 
			...
			"'END'", "'MAPJOIN'", "'STREAMTABLE'", "'CLUSTERSTATUS'", "'UTC'", "'UTCTIMESTAMP'", 
			...
			null, "'QUERY'", "'QUARTER'", null, null, null, "'DOW'", null, null, 
			null, "'START'", "'TRANSACTION'", "'COMMIT'", "'ROLLBACK'", "'WORK'", 
