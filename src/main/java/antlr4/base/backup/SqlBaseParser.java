...
public class SqlBaseParser extends Parser {
	...
	public static final int
		...
		GROUPING=83, HAVING=84, HOUR=85, IF=86, IGNORE=87, IN=88, INCLUDING=89, 
		INNER=90, INPUT=91, INSERT=92, INTERSECT=93, INTERVAL=94, INTO=95, INVOKER=96, 
		IO=97, IS=98, ISOLATION=99, JSON=100, JOIN=101, LANGUAGE=102, LAST=103, 
		LATERAL=104, LEFT=105, LEVEL=106, LIKE=107, LIMIT=108, LOCALTIME=109, 
		LOCALTIMESTAMP=110, LOGICAL=111, MAP=112, MATERIALIZED=113, MINUTE=114, 
		MONTH=115, NAME=116, NATURAL=117, NFC=118, NFD=119, NFKC=120, NFKD=121, 
		NO=122, NONE=123, NORMALIZE=124, NOT=125, NULL=126, NULLIF=127, NULLS=128, 
		OFFSET=129, ON=130, ONLY=131, OPTION=132, OR=133, ORDER=134, ORDINALITY=135, 
		OUTER=136, OUTPUT=137, OVER=138, PARTITION=139, PARTITIONS=140, POSITION=141, 
		PRECEDING=142, PREPARE=143, PRIVILEGES=144, PROPERTIES=145, RANGE=146, 
		READ=147, RECURSIVE=148, REFRESH=149, RENAME=150, REPEATABLE=151, REPLACE=152, 
		RESET=153, RESPECT=154, RESTRICT=155, RETURN=156, RETURNS=157, REVOKE=158, 
		RIGHT=159, ROLE=160, ROLES=161, ROLLBACK=162, ROLLUP=163, ROW=164, ROWS=165, 
		SCHEMA=166, SCHEMAS=167, SECOND=168, SECURITY=169, SELECT=170, SERIALIZABLE=171, 
		SESSION=172, SET=173, SETS=174, SHOW=175, SOME=176, SQL=177, START=178, 
		STATS=179, SUBSTRING=180, SYSTEM=181, TABLE=182, TABLES=183, TABLESAMPLE=184, 
		TEMPORARY=185, TEXT=186, THEN=187, TIME=188, TIMESTAMP=189, TO=190, TRANSACTION=191, 
		TRUE=192, TRUNCATE=193, TRY_CAST=194, TYPE=195, UESCAPE=196, UNBOUNDED=197, 
		UNCOMMITTED=198, UNION=199, UNNEST=200, USE=201, USER=202, USING=203, 
		VALIDATE=204, VALUES=205, VERBOSE=206, VIEW=207, WHEN=208, WHERE=209, 
		WITH=210, WORK=211, WRITE=212, YEAR=213, ZONE=214, EQ=215, NEQ=216, LT=217, 
		LTE=218, GT=219, GTE=220, PLUS=221, MINUS=222, ASTERISK=223, SLASH=224, 
		PERCENT=225, CONCAT=226, STRING=227, UNICODE_STRING=228, BINARY_LITERAL=229, 
		INTEGER_VALUE=230, DECIMAL_VALUE=231, DOUBLE_VALUE=232, IDENTIFIER=233, 
		DIGIT_IDENTIFIER=234, QUOTED_IDENTIFIER=235, BACKQUOTED_IDENTIFIER=236, 
		TIME_WITH_TIME_ZONE=237, TIMESTAMP_WITH_TIME_ZONE=238, DOUBLE_PRECISION=239, 
		SIMPLE_COMMENT=240, BRACKETED_COMMENT=241, WS=242, UNRECOGNIZED=243, DELIMITER=244;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'GRAPHVIZ'", "'GROUP'", "'GROUPING'", "'HAVING'", "'HOUR'", "'IF'", 
			"'IGNORE'", "'IN'", "'INCLUDING'", "'INNER'", "'INPUT'", "'INSERT'", 
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 24:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2353942828582394880L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -8079574437392551179L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & -594479585367720293L) != 0) || ((((_la - 193)) & ~0x3f) == 0 && ((1L << (_la - 193)) & 16492678376247L) != 0)) {
					{
					setState(440);
					sqlParameterDeclaration();
					setState(445);
			...
			case 27:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -6869397322032522204L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -9018352027831553L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & -594479585367720293L) != 0) || ((((_la - 192)) & ~0x3f) == 0 && ((1L << (_la - 192)) & 175889119237743L) != 0)) {
					{
					setState(484);
					callArgument();
					setState(489);
	...
	public final RoutineCharacteristicsContext routineCharacteristics() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==CALLED || _la==DETERMINISTIC || ((((_la - 102)) & ~0x3f) == 0 && ((1L << (_la - 102)) & 36028797027352577L) != 0)) {
				{
				{
				setState(867);
	...
	private PrimaryExpressionContext primaryExpression(int _p) throws RecognitionException {
		...
		try {
			...
			case 14:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -6851382923523040220L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -9018352027831553L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & -594479585367720293L) != 0) || ((((_la - 192)) & ~0x3f) == 0 && ((1L << (_la - 192)) & 175889119237743L) != 0)) {
					{
					setState(1410);
					_errHandler.sync(this);
	...
	public final IntervalFieldContext intervalField() throws RecognitionException {
		...
		try {
			...
			setState(1647);
			_la = _input.LA(1);
			if ( !(_la==DAY || ((((_la - 85)) & ~0x3f) == 0 && ((1L << (_la - 85)) & 1610612737L) != 0) || _la==SECOND || _la==YEAR) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final TypesContext types() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2353942828582394880L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -8079574437392551179L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & -594479585367720293L) != 0) || ((((_la - 193)) & ~0x3f) == 0 && ((1L << (_la - 193)) & 139637980687159L) != 0)) {
				{
				setState(1652);
				type(0);
				setState(1657);
	...
	public final ExplainOptionContext explainOption() throws RecognitionException {
		...
		try {
			...
			case TYPE:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 55)) & ~0x3f) == 0 && ((1L << (_la - 55)) & 72061992084439041L) != 0) || _la==VALIDATE) ) {
	...
	public final NonReservedContext nonReserved() throws RecognitionException {
		...
		try {
			...
			setState(1876);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 2353942828582394880L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -8079574437392551179L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & -594479585367720293L) != 0) || ((((_la - 193)) & ~0x3f) == 0 && ((1L << (_la - 193)) & 3959607L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static final String _serializedATN =
		...
		"?\u0003?\u06fd\b?\u0001@\u0001@\u0001@\u0001@\u0001@\u0001@\u0001@\u0001"+
		"@\u0001@\u0003@\u0708\b@\u0001A\u0001A\u0001A\u0001A\u0003A\u070e\bA\u0001"+
		"B\u0001B\u0001B\u0001B\u0001B\u0003B\u0715\bB\u0001C\u0001C\u0001C\u0001"+
		"C\u0001C\u0001C\u0001C\u0003C\u071e\bC\u0001D\u0001D\u0001D\u0001D\u0001"+
		"D\u0003D\u0725\bD\u0001E\u0001E\u0001E\u0001E\u0003E\u072b\bE\u0001F\u0001"+
		"F\u0001F\u0005F\u0730\bF\nF\fF\u0733\tF\u0001G\u0001G\u0001G\u0003G\u0738"+
		"\bG\u0001H\u0001H\u0001H\u0001H\u0001H\u0003H\u073f\bH\u0001I\u0001I\u0001"+
		"I\u0005I\u0744\bI\nI\fI\u0747\tI\u0001J\u0001J\u0001J\u0001J\u0001J\u0003"+
		"J\u074e\bJ\u0001K\u0001K\u0001K\u0003K\u0753\bK\u0001L\u0001L\u0001L\u0000"+
		"\u00060DVZ\\rM\u0000\u0002\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016"+
		...
		"\u0003\u0000QQdd\u00ba\u00ba\u0004\u000077aaoo\u00cc\u00cc\u0002\u0000"+
		"\u0083\u0083\u00d4\u00d4/\u0000\n\f\u000e\u000e\u0010\u0011\u0013\u0015"+
		"\u0018\u001a\u001d\"\'\'))-/11335577==@@BBDGIILQUWYY[[^^`acdfhjjllotv"+
		"{\u007f\u0081\u0083\u0084\u0087\u0087\u0089\u008e\u0090\u0093\u0095\u009e"+
		"\u00a0\u00a2\u00a4\u00a9\u00ab\u00b5\u00b7\u00ba\u00bc\u00bf\u00c1\u00c3"+
		"\u00c5\u00c6\u00c9\u00ca\u00cc\u00cc\u00ce\u00cf\u00d3\u00d6\u0881\u0000"+
		"\u009a\u0001\u0000\u0000\u0000\u0002\u009d\u0001\u0000\u0000\u0000\u0004"+
