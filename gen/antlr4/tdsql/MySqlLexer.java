// Generated from /Users/uuuuuuu/IdeaProjects/work/antlr4-gen/src/main/java/antlr4/tdsql/MySqlLexer.g4 by ANTLR 4.13.1
package antlr4.tdsql;
...
public class MySqlLexer extends Lexer {
	...
	public static final int
		SPACE=1, SPEC_MYSQL_COMMENT=2, COMMENT_INPUT=3, LINE_COMMENT=4, SHARDKEY=5, 
		TDSQL_DISTRIBUTED=6, ADD=7, ALL=8, ALTER=9, ALWAYS=10, ANALYZE=11, AND=12, 
		ARRAY=13, AS=14, ASC=15, ATTRIBUTE=16, BEFORE=17, BETWEEN=18, BOTH=19, 
		BUCKETS=20, BY=21, CALL=22, CASCADE=23, CASE=24, CAST=25, CHANGE=26, CHARACTER=27, 
		CHECK=28, COLLATE=29, COLUMN=30, CONDITION=31, CONSTRAINT=32, CONTINUE=33, 
		CONVERT=34, CREATE=35, CROSS=36, CURRENT=37, CURRENT_ROLE=38, CURRENT_USER=39, 
		CURSOR=40, DATABASE=41, DATABASES=42, DECLARE=43, DEFAULT=44, DELAYED=45, 
		DELETE=46, DESC=47, DESCRIBE=48, DETERMINISTIC=49, DIAGNOSTICS=50, DISTINCT=51, 
		DISTINCTROW=52, DROP=53, EACH=54, ELSE=55, ELSEIF=56, EMPTY=57, ENCLOSED=58, 
		ENFORCED=59, ESCAPED=60, EXCEPT=61, EXISTS=62, EXIT=63, EXPLAIN=64, FALSE=65, 
		FETCH=66, FOR=67, FORCE=68, FOREIGN=69, FROM=70, FULLTEXT=71, GENERATED=72, 
		GET=73, GRANT=74, GROUP=75, HAVING=76, HIGH_PRIORITY=77, HISTOGRAM=78, 
		IF=79, IGNORE=80, IGNORED=81, IN=82, INDEX=83, INFILE=84, INNER=85, INOUT=86, 
		INSERT=87, INTERVAL=88, INTO=89, IS=90, ITERATE=91, JOIN=92, KEY=93, KEYS=94, 
		KILL=95, LATERAL=96, LEADING=97, LEAVE=98, LEFT=99, LIKE=100, LIMIT=101, 
		LINEAR=102, LINES=103, LOAD=104, LOCK=105, LOCKED=106, LOOP=107, LOW_PRIORITY=108, 
		MASTER_BIND=109, MASTER_SSL_VERIFY_SERVER_CERT=110, MATCH=111, MAXVALUE=112, 
		MINVALUE=113, MODIFIES=114, NATURAL=115, NOT=116, NO_WRITE_TO_BINLOG=117, 
		NULL_LITERAL=118, NUMBER=119, ON=120, OPTIMIZE=121, OPTION=122, OPTIONAL=123, 
		OPTIONALLY=124, OR=125, ORDER=126, OUT=127, OUTER=128, OUTFILE=129, OVER=130, 
		PARTITION=131, PRIMARY=132, PROCEDURE=133, PURGE=134, RANGE=135, READ=136, 
		READS=137, REFERENCES=138, REGEXP=139, RELEASE=140, RENAME=141, REPEAT=142, 
		REPLACE=143, REQUIRE=144, RESIGNAL=145, RESTRICT=146, RETAIN=147, RETURN=148, 
		REVOKE=149, RIGHT=150, RLIKE=151, SCHEMA=152, SCHEMAS=153, SELECT=154, 
		SET=155, SEPARATOR=156, SHOW=157, SIGNAL=158, SKIP_=159, SKIP_QUERY_REWRITE=160, 
		SPATIAL=161, SQL=162, SQLEXCEPTION=163, SQLSTATE=164, SQLWARNING=165, 
		SQL_BIG_RESULT=166, SQL_CALC_FOUND_ROWS=167, SQL_SMALL_RESULT=168, SSL=169, 
		STACKED=170, STARTING=171, STATEMENT=172, STRAIGHT_JOIN=173, TABLE=174, 
		...
		USAGE=187, USE=188, USING=189, VALUES=190, WHEN=191, WHERE=192, WHILE=193, 
		WITH=194, WRITE=195, XOR=196, ZEROFILL=197, TINYINT=198, SMALLINT=199, 
		MEDIUMINT=200, MIDDLEINT=201, INT=202, INT1=203, INT2=204, INT3=205, INT4=206, 
		INT8=207, INTEGER=208, BIGINT=209, REAL=210, DOUBLE=211, PRECISION=212, 
		FLOAT=213, FLOAT4=214, FLOAT8=215, DECIMAL=216, DEC=217, NUMERIC=218, 
		DATE=219, TIME=220, TIMESTAMP=221, DATETIME=222, YEAR=223, CHAR=224, VARCHAR=225, 
		NVARCHAR=226, NATIONAL=227, BINARY=228, VARBINARY=229, TINYBLOB=230, BLOB=231, 
		MEDIUMBLOB=232, LONG=233, LONGBLOB=234, TINYTEXT=235, TEXT=236, MEDIUMTEXT=237, 
		LONGTEXT=238, ENUM=239, VARYING=240, SERIAL=241, YEAR_MONTH=242, DAY_HOUR=243, 
		DAY_MINUTE=244, DAY_SECOND=245, HOUR_MINUTE=246, HOUR_SECOND=247, MINUTE_SECOND=248, 
		SECOND_MICROSECOND=249, MINUTE_MICROSECOND=250, HOUR_MICROSECOND=251, 
		DAY_MICROSECOND=252, JSON_ARRAY=253, JSON_ARRAYAGG=254, JSON_ARRAY_APPEND=255, 
		JSON_ARRAY_INSERT=256, JSON_CONTAINS=257, JSON_CONTAINS_PATH=258, JSON_DEPTH=259, 
		JSON_EXTRACT=260, JSON_INSERT=261, JSON_KEYS=262, JSON_LENGTH=263, JSON_MERGE=264, 
		JSON_MERGE_PATCH=265, JSON_MERGE_PRESERVE=266, JSON_OBJECT=267, JSON_OBJECTAGG=268, 
		JSON_OVERLAPS=269, JSON_PRETTY=270, JSON_QUOTE=271, JSON_REMOVE=272, JSON_REPLACE=273, 
		JSON_SCHEMA_VALID=274, JSON_SCHEMA_VALIDATION_REPORT=275, JSON_SEARCH=276, 
		JSON_SET=277, JSON_STORAGE_FREE=278, JSON_STORAGE_SIZE=279, JSON_TABLE=280, 
		JSON_TYPE=281, JSON_UNQUOTE=282, JSON_VALID=283, JSON_VALUE=284, NESTED=285, 
		ORDINALITY=286, PATH=287, AVG=288, BIT_AND=289, BIT_OR=290, BIT_XOR=291, 
		COUNT=292, CUME_DIST=293, DENSE_RANK=294, FIRST_VALUE=295, GROUP_CONCAT=296, 
		LAG=297, LAST_VALUE=298, LEAD=299, MAX=300, MIN=301, NTILE=302, NTH_VALUE=303, 
		PERCENT_RANK=304, RANK=305, ROW_NUMBER=306, STD=307, STDDEV=308, STDDEV_POP=309, 
		STDDEV_SAMP=310, SUM=311, VAR_POP=312, VAR_SAMP=313, VARIANCE=314, CURRENT_DATE=315, 
		CURRENT_TIME=316, CURRENT_TIMESTAMP=317, LOCALTIME=318, CURDATE=319, CURTIME=320, 
		DATE_ADD=321, DATE_SUB=322, EXTRACT=323, LOCALTIMESTAMP=324, NOW=325, 
		POSITION=326, SUBSTR=327, SUBSTRING=328, SYSDATE=329, TRIM=330, UTC_DATE=331, 
		UTC_TIME=332, UTC_TIMESTAMP=333, ACCOUNT=334, ACTION=335, AFTER=336, AGGREGATE=337, 
		...
		LAST=471, LEAVES=472, LESS=473, LEVEL=474, LIST=475, LOCAL=476, LOGFILE=477, 
		LOGS=478, MASTER=479, MASTER_AUTO_POSITION=480, MASTER_CONNECT_RETRY=481, 
		MASTER_DELAY=482, MASTER_HEARTBEAT_PERIOD=483, MASTER_HOST=484, MASTER_LOG_FILE=485, 
		MASTER_LOG_POS=486, MASTER_PASSWORD=487, MASTER_PORT=488, MASTER_RETRY_COUNT=489, 
		MASTER_SSL=490, MASTER_SSL_CA=491, MASTER_SSL_CAPATH=492, MASTER_SSL_CERT=493, 
		MASTER_SSL_CIPHER=494, MASTER_SSL_CRL=495, MASTER_SSL_CRLPATH=496, MASTER_SSL_KEY=497, 
		MASTER_TLS_VERSION=498, MASTER_USER=499, MAX_CONNECTIONS_PER_HOUR=500, 
		MAX_QUERIES_PER_HOUR=501, MAX_ROWS=502, MAX_SIZE=503, MAX_UPDATES_PER_HOUR=504, 
		MAX_USER_CONNECTIONS=505, MEDIUM=506, MEMBER=507, MERGE=508, MESSAGE_TEXT=509, 
		MID=510, MIGRATE=511, MIN_ROWS=512, MODE=513, MODIFY=514, MUTEX=515, MYSQL=516, 
		MYSQL_ERRNO=517, NAME=518, NAMES=519, NCHAR=520, NEVER=521, NEXT=522, 
		NO=523, NOCACHE=524, NOCOPY=525, NOCYCLE=526, NOMAXVALUE=527, NOMINVALUE=528, 
		NOWAIT=529, NODEGROUP=530, NONE=531, ODBC=532, OFFLINE=533, OFFSET=534, 
		OF=535, OJ=536, OLD_PASSWORD=537, ONE=538, ONLINE=539, ONLY=540, OPEN=541, 
		OPTIMIZER_COSTS=542, OPTIONS=543, OWNER=544, PACK_KEYS=545, PAGE=546, 
		PAGE_COMPRESSED=547, PAGE_COMPRESSION_LEVEL=548, PARSER=549, PARTIAL=550, 
		PARTITIONING=551, PARTITIONS=552, PASSWORD=553, PASSWORD_LOCK_TIME=554, 
		PHASE=555, PLUGIN=556, PLUGIN_DIR=557, PLUGINS=558, PORT=559, PRECEDES=560, 
		PRECEDING=561, PREPARE=562, PRESERVE=563, PREV=564, PROCESSLIST=565, PROFILE=566, 
		PROFILES=567, PROXY=568, QUERY=569, QUICK=570, REBUILD=571, RECOVER=572, 
		RECURSIVE=573, REDO_BUFFER_SIZE=574, REDUNDANT=575, RELAY=576, RELAY_LOG_FILE=577, 
		RELAY_LOG_POS=578, RELAYLOG=579, REMOVE=580, REORGANIZE=581, REPAIR=582, 
		REPLICATE_DO_DB=583, REPLICATE_DO_TABLE=584, REPLICATE_IGNORE_DB=585, 
		REPLICATE_IGNORE_TABLE=586, REPLICATE_REWRITE_DB=587, REPLICATE_WILD_DO_TABLE=588, 
		REPLICATE_WILD_IGNORE_TABLE=589, REPLICATION=590, RESET=591, RESTART=592, 
		RESUME=593, RETURNED_SQLSTATE=594, RETURNING=595, RETURNS=596, REUSE=597, 
		ROLE=598, ROLLBACK=599, ROLLUP=600, ROTATE=601, ROW=602, ROWS=603, ROW_FORMAT=604, 
		RTREE=605, SAVEPOINT=606, SCHEDULE=607, SECURITY=608, SEQUENCE=609, SERVER=610, 
		SESSION=611, SHARE=612, SHARED=613, SIGNED=614, SIMPLE=615, SLAVE=616, 
		SLOW=617, SNAPSHOT=618, SOCKET=619, SOME=620, SONAME=621, SOUNDS=622, 
		SOURCE=623, SQL_AFTER_GTIDS=624, SQL_AFTER_MTS_GAPS=625, SQL_BEFORE_GTIDS=626, 
		SQL_BUFFER_RESULT=627, SQL_CACHE=628, SQL_NO_CACHE=629, SQL_THREAD=630, 
		START=631, STARTS=632, STATS_AUTO_RECALC=633, STATS_PERSISTENT=634, STATS_SAMPLE_PAGES=635, 
		STATUS=636, STOP=637, STORAGE=638, STORED=639, STRING=640, SUBCLASS_ORIGIN=641, 
		SUBJECT=642, SUBPARTITION=643, SUBPARTITIONS=644, SUSPEND=645, SWAPS=646, 
		SWITCHES=647, TABLE_NAME=648, TABLESPACE=649, TABLE_TYPE=650, TEMPORARY=651, 
		TEMPTABLE=652, THAN=653, TRADITIONAL=654, TRANSACTION=655, TRANSACTIONAL=656, 
		TRIGGERS=657, TRUNCATE=658, UNBOUNDED=659, UNDEFINED=660, UNDOFILE=661, 
		UNDO_BUFFER_SIZE=662, UNINSTALL=663, UNKNOWN=664, UNTIL=665, UPGRADE=666, 
		USER=667, USE_FRM=668, USER_RESOURCES=669, VALIDATION=670, VALUE=671, 
		VARIABLES=672, VIEW=673, VIRTUAL=674, VISIBLE=675, WAIT=676, WARNINGS=677, 
		WINDOW=678, WITHOUT=679, WORK=680, WRAPPER=681, X509=682, XA=683, XML=684, 
		YES=685, EUR=686, USA=687, JIS=688, ISO=689, INTERNAL=690, QUARTER=691, 
		MONTH=692, DAY=693, HOUR=694, MINUTE=695, WEEK=696, SECOND=697, MICROSECOND=698, 
		ADMIN=699, APPLICATION_PASSWORD_ADMIN=700, AUDIT_ABORT_EXEMPT=701, AUDIT_ADMIN=702, 
		AUTHENTICATION_POLICY_ADMIN=703, BACKUP_ADMIN=704, BINLOG_ADMIN=705, BINLOG_ENCRYPTION_ADMIN=706, 
		CLONE_ADMIN=707, CONNECTION_ADMIN=708, ENCRYPTION_KEY_ADMIN=709, EXECUTE=710, 
		FILE=711, FIREWALL_ADMIN=712, FIREWALL_EXEMPT=713, FIREWALL_USER=714, 
		...
		DISJOINT=872, ELT=873, ENCODE=874, ENCRYPT=875, ENDPOINT=876, ENGINE_ATTRIBUTE=877, 
		ENVELOPE=878, EQUALS=879, EXP=880, EXPORT_SET=881, EXTERIORRING=882, EXTRACTVALUE=883, 
		FIELD=884, FIND_IN_SET=885, FLOOR=886, FORMAT=887, FOUND_ROWS=888, FROM_BASE64=889, 
		FROM_DAYS=890, FROM_UNIXTIME=891, GEOMCOLLFROMTEXT=892, GEOMCOLLFROMWKB=893, 
		GEOMETRYCOLLECTIONFROMTEXT=894, GEOMETRYCOLLECTIONFROMWKB=895, GEOMETRYFROMTEXT=896, 
		GEOMETRYFROMWKB=897, GEOMETRYN=898, GEOMETRYTYPE=899, GEOMFROMTEXT=900, 
		GEOMFROMWKB=901, GET_FORMAT=902, GET_LOCK=903, GLENGTH=904, GREATEST=905, 
		GTID_SUBSET=906, GTID_SUBTRACT=907, HEX=908, IFNULL=909, INET6_ATON=910, 
		INET6_NTOA=911, INET_ATON=912, INET_NTOA=913, INSTR=914, INTERIORRINGN=915, 
		INTERSECTS=916, ISCLOSED=917, ISEMPTY=918, ISNULL=919, ISSIMPLE=920, IS_FREE_LOCK=921, 
		IS_IPV4=922, IS_IPV4_COMPAT=923, IS_IPV4_MAPPED=924, IS_IPV6=925, IS_USED_LOCK=926, 
		LAST_INSERT_ID=927, LCASE=928, LEAST=929, LENGTH=930, LINEFROMTEXT=931, 
		LINEFROMWKB=932, LINESTRINGFROMTEXT=933, LINESTRINGFROMWKB=934, LN=935, 
		LOAD_FILE=936, LOCATE=937, LOG=938, LOG10=939, LOG2=940, LOWER=941, LPAD=942, 
		LTRIM=943, MAKEDATE=944, MAKETIME=945, MAKE_SET=946, MASTER_POS_WAIT=947, 
		MBRCONTAINS=948, MBRDISJOINT=949, MBREQUAL=950, MBRINTERSECTS=951, MBROVERLAPS=952, 
		MBRTOUCHES=953, MBRWITHIN=954, MD5=955, MLINEFROMTEXT=956, MLINEFROMWKB=957, 
		MONTHNAME=958, MPOINTFROMTEXT=959, MPOINTFROMWKB=960, MPOLYFROMTEXT=961, 
		MPOLYFROMWKB=962, MULTILINESTRINGFROMTEXT=963, MULTILINESTRINGFROMWKB=964, 
		MULTIPOINTFROMTEXT=965, MULTIPOINTFROMWKB=966, MULTIPOLYGONFROMTEXT=967, 
		MULTIPOLYGONFROMWKB=968, NAME_CONST=969, NULLIF=970, NUMGEOMETRIES=971, 
		NUMINTERIORRINGS=972, NUMPOINTS=973, OCT=974, OCTET_LENGTH=975, ORD=976, 
		OVERLAPS=977, PERIOD_ADD=978, PERIOD_DIFF=979, PI=980, POINTFROMTEXT=981, 
		...
		ST_UNION=1072, ST_WITHIN=1073, ST_X=1074, ST_Y=1075, SUBDATE=1076, SUBSTRING_INDEX=1077, 
		SUBTIME=1078, SYSTEM_USER=1079, TAN=1080, TIMEDIFF=1081, TIMESTAMPADD=1082, 
		TIMESTAMPDIFF=1083, TIME_FORMAT=1084, TIME_TO_SEC=1085, TOUCHES=1086, 
		TO_BASE64=1087, TO_DAYS=1088, TO_SECONDS=1089, TP_CONNECTION_ADMIN=1090, 
		UCASE=1091, UNCOMPRESS=1092, UNCOMPRESSED_LENGTH=1093, UNHEX=1094, UNIX_TIMESTAMP=1095, 
		UPDATEXML=1096, UPPER=1097, UUID=1098, UUID_SHORT=1099, VALIDATE_PASSWORD_STRENGTH=1100, 
		VERSION=1101, WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS=1102, WEEKDAY=1103, WEEKOFYEAR=1104, 
		WEIGHT_STRING=1105, WITHIN=1106, YEARWEEK=1107, Y_FUNCTION=1108, X_FUNCTION=1109, 
		VAR_ASSIGN=1110, PLUS_ASSIGN=1111, MINUS_ASSIGN=1112, MULT_ASSIGN=1113, 
		DIV_ASSIGN=1114, MOD_ASSIGN=1115, AND_ASSIGN=1116, XOR_ASSIGN=1117, OR_ASSIGN=1118, 
		STAR=1119, DIVIDE=1120, MODULE=1121, PLUS=1122, MINUS=1123, DIV=1124, 
		MOD=1125, EQUAL_SYMBOL=1126, GREATER_SYMBOL=1127, LESS_SYMBOL=1128, EXCLAMATION_SYMBOL=1129, 
		BIT_NOT_OP=1130, BIT_OR_OP=1131, BIT_AND_OP=1132, BIT_XOR_OP=1133, DOT=1134, 
		LR_BRACKET=1135, RR_BRACKET=1136, COMMA=1137, SEMI=1138, AT_SIGN=1139, 
		ZERO_DECIMAL=1140, ONE_DECIMAL=1141, TWO_DECIMAL=1142, SINGLE_QUOTE_SYMB=1143, 
		DOUBLE_QUOTE_SYMB=1144, REVERSE_QUOTE_SYMB=1145, COLON_SYMB=1146, CHARSET_REVERSE_QOUTE_STRING=1147, 
		FILESIZE_LITERAL=1148, START_NATIONAL_STRING_LITERAL=1149, STRING_LITERAL=1150, 
		DECIMAL_LITERAL=1151, HEXADECIMAL_LITERAL=1152, REAL_LITERAL=1153, NULL_SPEC_LITERAL=1154, 
		BIT_STRING=1155, STRING_CHARSET_NAME=1156, DOT_ID=1157, ID=1158, REVERSE_QUOTE_ID=1159, 
		HOST_IP_ADDRESS=1160, LOCAL_ID=1161, GLOBAL_ID=1162, ERROR_RECONGNIGION=1163;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SPACE", "SPEC_MYSQL_COMMENT", "COMMENT_INPUT", "LINE_COMMENT", "SHARDKEY", 
			"TDSQL_DISTRIBUTED", "ADD", "ALL", "ALTER", "ALWAYS", "ANALYZE", "AND", 
			"ARRAY", "AS", "ASC", "ATTRIBUTE", "BEFORE", "BETWEEN", "BOTH", "BUCKETS", 
			...
			"DROP", "EACH", "ELSE", "ELSEIF", "EMPTY", "ENCLOSED", "ENFORCED", "ESCAPED", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, null, null, null, "'SHARDKEY'", "'TDSQL_DISTRIBUTED'", "'ADD'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SHARDKEY", "TDSQL_DISTRIBUTED", "ADD", "ALL", "ALTER", "ALWAYS", "ANALYZE", 
			"AND", "ARRAY", "AS", "ASC", "ATTRIBUTE", "BEFORE", "BETWEEN", "BOTH", 
	...
	private static final String _serializedATNSegment1 =
		...
		"\u0000\u092b\u048b\u0001\u0000*\u0003\u0000\t\n\r\r  \u0002\u0000\t\t"+
		"  \u0002\u0000\n\n\r\r\u0002\u0000SSss\u0002\u0000HHhh\u0002\u0000AAa"+
		"a\u0002\u0000RRrr\u0002\u0000DDdd\u0002\u0000KKkk\u0002\u0000EEee\u0002"+
		"\u0000YYyy\u0002\u0000TTtt\u0002\u0000QQqq\u0002\u0000LLll\u0002\u0000"+
		"IIii\u0002\u0000BBbb\u0002\u0000UUuu\u0002\u0000WWww\u0002\u0000NNnn\u0002"+
		"\u0000ZZzz\u0002\u0000CCcc\u0002\u0000FFff\u0002\u0000OOoo\u0002\u0000"+
		"GGgg\u0002\u0000MMmm\u0002\u0000VVvv\u0002\u0000PPpp\u0002\u0000XXxx\u0002"+
		"\u0000JJjj\b\u0000GGKKMMTTggkkmmtt\u0007\u0000$$..09AZ__az\u0080\u8000"+
		"\uffff\u0002\u0000++--\u0006\u0000$$09AZ__az\u0080\u8000\uffff\u0005\u0000"+
		"$$AZ__az\u0080\u8000\uffff\u0002\u0000\"\"\\\\\u0002\u0000\'\'\\\\\u0001"+
		"\u0000``\u0003\u000009AFaf\u0001\u000009\u0001\u000001\u0002\u0000..0"+
		"9\u0003\u00000:AFaf\u35fd\u0000\u0001\u0001\u0000\u0000\u0000\u0000\u0003"+
